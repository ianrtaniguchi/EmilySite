  ...
  const alarmSound = new Audio('https://www.soundjay.com/buttons/sounds/beep-07a.mp3');
    ...
    const renderTasks = () => {
        ...
        filteredTasks.forEach(task => {
            ...
            li.innerHTML = `
                <div class="task-status ${task.completed ? 'completed' : ''}" data-action="toggle">
                ...
                <div class="task-info">
                    ...
                    <div class="task-details">
                        ...
                        <span><i class="far fa-calendar-alt"></i>${task.frequency}</span>
                    </div>
                </div>
                <div class="task-actions">
                    <i class="fas fa-star favorite ${task.favorite ? 'is-favorite' : ''}" data-action="favorite"></i>
